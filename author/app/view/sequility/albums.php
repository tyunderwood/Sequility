...
<tr><td colspan="2" width="100%">	
	...
	<tr style="height:30px">
		...
		<th width="40%">Album Title/Edit</th>
	...
	<tr class="<?php echo fmod($key,2)?'altrow':''; ?>">
		...
		<td width="15%"><?php echo $fval['name']; ?></td>	
		<td width="40%"><a href="index.php?c=albums/edit&album_id=<?php echo $fval['album_id']; ?>"><?php echo $fval['title']; ?></a></td>
    ...
    <td width="10%" align="center">
		<a href="index.php?c=albums/delete&album_id=<? echo $fval['album_id']; ?>&gallery_id=<? echo $fval['gallery_id']; ?>" id="delete" ><img src="<?php echo $tpath; ?>images/delete.png" alt="Delete"></a></td>

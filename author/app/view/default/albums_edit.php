<?php
    ...
    $cancellink = 'index.php?c=albums&gallery_id='.$gallery_id.'&page='.$page.'&mode=reset';
...
<?php 
    ...
    if (file_exists($busy_name)) {
        ...
        echo "<tr><td>Click<a href='$cancellink'> here</a> to reset in case you cannot upload more albums. This is NOT a cancel function!</td></tr>"; 
        echo '</table></form>';
...
<tr><td>Upload folder:</td><td><a href="javascript:showApplet();" >Select local folder</a><br/>
<iframe  id="applet_iframe" style="display:none;width:670px;height:520px;"
    src="<?php echo $link; ?>"></iframe>
</td></tr>
<br/>
<tr><td>Upload PDF:</td><td><input onclick="hideApplet();" type="file" name="PDFile" id="PDFile"  size="60"  /></td></tr>

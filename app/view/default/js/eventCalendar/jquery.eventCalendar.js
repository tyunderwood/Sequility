...
;$.fn.eventCalendar = function(options){
	...
	function getEvents(limit, year, month, day, direction) {
		...
		if (eventsOpts.jsonData) {
			...
			var url = eventsOpts.eventsjson + 
                        "?limit="+limit+"&year="+year+"&month="+month+"&day="+day + 
                        eventsOpts.params;
	...
	function getEventsData(data, limit, year, month, day, direction){
		...
		// added by MK
		var sliderElement = flags.wrap.find('.eventsCalendar-slider');
		var sliderHeight = sliderElement.height();
        sliderElement.height(eventsOpts.minSliderHeight);
		//
	}
	...
	function setCalendarWidth(){
        ...
        $('#eventCalendar').css('width',eventsOpts.minCalendarWidth);
	}
};

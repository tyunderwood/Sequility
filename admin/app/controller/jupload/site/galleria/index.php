...
$classParameters = array(
        ...
        'destdir' => 'files',  //Where to store the files on the web
...
<html>
  ...
  <body>
    ...
    <div id="jupload_files" align="center"><!--JUPLOAD_FILES--></div>
    <div  id="jupload_applet" align="center"><!--JUPLOAD_APPLET--></div>
  </body>
</html>